...
(custom-set-variables
 ...
 '(ledger-reports
   '(("bank+credit card balance" "ledger [[ledger-mode-flags]] -f /home/nicklamberth/Sync/projects/ledger/main.ledger bal assets liabilities and not loans -e \"today\"")
     ...
     ("balance income and expenses" "ledger [[ledger-mode-flags]] -f /home/nicklamberth/Sync/projects/ledger/main.ledger bal income expenses")
     ("bank and credit card register" "ledger [[ledger-mode-flags]] -f /home/nicklamberth/Sync/projects/ledger/main.ledger reg assets liabilities and not loans")
 ...
 '(package-selected-packages
   '(ledger-mode embark-consult embark sql-indent request goto-chg org-jira drag-stuff markdown-mode yaml-mode jump-char puni expand-region consult ace-window avy try orderless vertico multiple-cursors yasnippet-snippets which-key use-package undo-tree olivetti magit dumb-jump))
 '(repeat-mode t)
